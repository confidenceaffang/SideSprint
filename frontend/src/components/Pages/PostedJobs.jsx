...
const PostedJobs = () => {
  ...
  return (
    <div className="container bg-gradient-to-r from-black to-purple-900 items-center p-8">
      ...
      <h2 className="text-2xl font-semibold mb-6 text-white">Posted Jobs</h2>
          ...
          >
            <div
              className={`p-6 cursor-pointer ${
                job.status === "completed" ? "bg-gray-50" : ""
              }`}
