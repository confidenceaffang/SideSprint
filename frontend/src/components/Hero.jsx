          ...
          <div className="grid items-center grid-cols-1 gap-y-12 lg:grid-cols-2 gap-x-16">
            <div>
              ...
              <p className="mt-4 text-lg font-normal text-gray-400 sm:mt-8">
                Connect with skilled individuals in your area for all your everyday tasks.
                From home maintenance to errands, find reliable help when you need it.
                Join our community of helpers and seekers today.
              </p>
            </div>
